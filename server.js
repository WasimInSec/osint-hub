...
// Print nice welcome message to user
  const printMessage = () => {
    console.log(
      ...
      `\x1b[0m\n`,
      `\x1b[1m\x1b[32m🚀 OSINTHub is up and running at http://localhost:${port} \x1b[0m\n\n`,
      `\x1b[2m\x1b[36m🛟 For documentation and support, visit the GitHub repo: ` +
      `https://github.com/WasimInSec/osint-hub\n`,
      `💖 Found OSINTHub useful? Consider sponsoring us on GitHub ` +
